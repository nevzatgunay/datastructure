...
//	This program is just to take standard inputs.For example,25.00 60.00 30.00.

#include <stdio.h>

void getAveragedValue(float n[1000][3]);//we declare the function.
int line_number,i;//line_number holds the rows of the records and i is the index.
